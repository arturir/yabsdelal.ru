...
<head>
    ...
    <title>Ремонт Infinix во Владимире - сервис ЯбСделал</title><meta name='description' content='Сервисный центр по ремонту Infinix во Владимире. Замена дисплея, стекла, акб, батареи и разъема с гарантией.'/>
</head>
<?php include 'header.php';?>
<div>
            <div class="mainBanner">
                <h1 class="mainBanner_h1">Ремонт телефонов Infinix во Владимире</h1>
