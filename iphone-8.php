...
<head>
    ...
    <title>Ремонт iPhone 8 во Владимире - сервис ЯбСделал</title><meta name='description' content='Сервисный центр по ремонту iPhone 8 во Владимире. Замена дисплея, стекла, акб, батареи и разъема с гарантией.'/>
</head>
<?php include 'header.php';?>
<div>
            <div class="mainBanner">
                <h1 class="mainBanner_h1">Ремонт iPhone 8 во Владимире</h1>
