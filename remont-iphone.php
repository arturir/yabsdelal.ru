...
<div>
            <div class="mainBanner">
                <h1 class="mainBanner_h1">Ремонт iPhone во Владимире</h1>
            ...
            <div class="popularService">
                ...
                <div class="popularServiceItems">
                    <a href='/iphone-5s/' class='popularServiceItem'>iPhone 5S</a>
                    <a href='/iphone-6/' class='popularServiceItem'>iPhone 6</a>
                    <a href='/iphone-6-plus/' class='popularServiceItem'>iPhone 6+</a>
                    <a href='/iphone-6s/' class='popularServiceItem'>iPhone 6S</a>
                    <a href='/iphone-6s-plus/' class='popularServiceItem'>iPhone 6S+</a>
                    <a href='/iphone-se/' class='popularServiceItem'>iPhone SE</a>
                    <a href='/iphone-7/' class='popularServiceItem'>iPhone 7</a>
                    <a href='/iphone-7-plus/' class='popularServiceItem'>iPhone 7+</a>
                    <a href='/iphone-8/' class='popularServiceItem'>iPhone 8</a>
                    <a href='/iphone-8-plus/' class='popularServiceItem'>iPhone 8+</a>
                    <a href='/iphone-x/' class='popularServiceItem'>iPhone X</a>
                    <a href='/iphone-xs/' class='popularServiceItem'>iPhone Xs</a>
                    <a href='/iphone-xs-max/' class='popularServiceItem'>iPhone Xs Max</a>
                    <a href='/iphone-xr/' class='popularServiceItem'>iPhone Xr</a>
                    <a href='/iphone-11/' class='popularServiceItem'>iPhone 11</a>
                    <a href='/iphone-11-pro/' class='popularServiceItem'>iPhone 11 Pro</a>
                    <a href='/iphone-11-pro-max/' class='popularServiceItem'>iPhone 11 Pro Max</a>
                    <a href='/iphone-12/' class='popularServiceItem'>iPhone 12</a>
                    <a href='/iphone-12-pro/' class='popularServiceItem'>iPhone 12 Pro</a>
                    <a href='/iphone-12-pro-max/' class='popularServiceItem'>iPhone 12 Pro Max</a>
                    <a href='/iphone-13/' class='popularServiceItem'>iPhone 13</a>
                    <a href='/iphone-13-pro/' class='popularServiceItem'>iPhone 13 Pro</a>
                    <a href='/iphone-13-pro-max/' class='popularServiceItem'>iPhone 13 Pro Max</a>
                </div>
            </div>
